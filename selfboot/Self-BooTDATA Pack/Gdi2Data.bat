...
title=FamilyGuy's SelfBootDATA Pack! - Image2Data v2.1
ECHO.
...
ECHO.
title=FamilyGuy's SelfBootDATA Pack! - Image2Data v2.1 - Processing %GDIN% ...
...
:THERE
REM ECHO.
REM CHOICE /C:YN Run SELFBOOT.bat? (Good idea if the game fits a cd and isn't protected)%1
REM IF ERRORLEVEL ==2 GOTO END
REM IF ERRORLEVEL ==1 CALL SELFBOOT.BAT
GOTO END
